...
IGNORE_DIRS = {'.git', '__pycache__', 'venv', 'node_modules', 'cache', 'images','.vscode'}

IGNORE_EXTENSIONS = {'directory_structure.json','.png', '.jpg', '.jpeg', '.gif', '.bmp', '.ico', '.exe', '.dll', '.gitignore'}
